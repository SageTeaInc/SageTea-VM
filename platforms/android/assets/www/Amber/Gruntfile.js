...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/SagateaMobileApp.st', // list all sources in dependency order
                    'src/SagateaMobileApp-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-sagateamobileapp',
